...
.libs/install-gallium-links : $(dri_LTLIBRARIES) $(xvmc_LTLIBRARIES) $(vdpau_LTLIBRARIES) $(omx_LTLIBRARIES) $(egl_LTLIBRARIES) $(lib_LTLIBRARIES)
	...
	file_list+=$(xvmc_LTLIBRARIES:%.la=.libs/%.$(LIB_EXT)*); \
	file_list+=$(vdpau_LTLIBRARIES:%.la=.libs/%.$(LIB_EXT)*); \
	file_list+=$(omx_LTLIBRARIES:%.la=.libs/%.$(LIB_EXT)*);	\
